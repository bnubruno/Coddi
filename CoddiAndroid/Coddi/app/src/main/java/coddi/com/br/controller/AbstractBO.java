 ...
 */
public class AbstractBO<E extends AbstractPojo, F, G> implements IBusinessObject<E, F> {
    ...
    public List<E> buscarTodos(Long idUsuario) {
        return dao.buscarTodos(idUsuario);
    }

    @Override
    public List<E> buscarTodos(Long idUsuario, String orderBy) {
        return dao.buscarTodos(idUsuario, orderBy);
    }
